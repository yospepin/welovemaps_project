...
```{r}
income_mncounty <- read.csv("data exploration/CAINC4/CAINC4_MN_1969_2022.csv")
...
```{r}
demographic_agesex <- read.csv("data exploration/cc-est2019-agesex-27.csv")
head(demographic_agesex)

demographic_all <- read.csv("data exploration/cc-est2019-alldata-27.csv")
